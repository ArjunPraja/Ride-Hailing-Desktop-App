...
class DriverDashboard(ctk.CTkFrame):
    def __init__(self, parent, manager=None):
        ...
        self.btn_accept_ride.grid(row=4, column=0, pady=5)
        ...
        self.btn_start_ride.grid(row=5, column=0, pady=5)

        self.btn_add_vehicle = ctk.CTkButton(self.content_frame, text="Add Vehicle", command=self.add_vehicle, width=btn_width, height=btn_height, font=font_btn)
        self.btn_add_vehicle.grid(row=6, column=0, pady=5)

        self.btn_view_vehicles = ctk.CTkButton(self.content_frame, text="View My Vehicles", command=self.view_my_vehicles, width=btn_width, height=btn_height, font=font_btn)
        self.btn_view_vehicles.grid(row=7, column=0, pady=5)
